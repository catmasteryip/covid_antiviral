...
dexamethasone_shortlist = dexamethasone_shortlist %>%
  rename(timetoevent = daystilldexa)
weighted_results_dexa = calculate_hr(df = ip_tab1_df,
                                     eventdata = dexamethasone_shortlist,
                                     weights = weight$weights)
weighted_results_dexa
# death28d
weighted_results_death = calculate_hr(df = ip_tab1_df,
                                     eventdata = death_shortlist,
                                     weights = weight$weights)
weighted_results_death
```
